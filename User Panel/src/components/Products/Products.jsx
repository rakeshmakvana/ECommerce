                                ...
                                <Slider {...settings}>
                                    <div style={{ width: 200 }}>
                                        <button className='pr-btn'>
                                            <img src="https://www.jiomart.com//images/product/original/494260170/bharat-chana-dal-1-kg-product-images-o494260170-p606721409-0-202401271413.jpg?im=Resize=(310,310)" alt="img" className='mb-3' />
                                            <h4 className='mb-3'>Bharat Chana Dal 1 kg</h4>
                                            <h3 className='mb-3'>
                                                $60.00
                                            </h3>
                                            <button>Add</button>
